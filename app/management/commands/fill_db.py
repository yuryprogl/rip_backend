...
def add_calculations():
    ...
    for _ in range(30):
        ...
        add_calculation(status, elements, owner, moderators)

    add_calculation(1, elements, users[0], moderators)
    add_calculation(2, elements, users[0], moderators)


def add_calculation(status, elements, owner, moderators):
    ...
    calculation.volume = 50 * random.randint(5, 20)
